...
let appData = {
  ...
  //Блокировка кнопки если не введен месячный доход
...
start.disabled = true;
start.addEventListener('click', appData.blockStartBtn.bind(appData));
salaryAmount.addEventListener('input', appData.blockStartBtn.bind(appData));
